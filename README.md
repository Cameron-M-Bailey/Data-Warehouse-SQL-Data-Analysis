...
# Objective 
The project builds a small-scale data warehouse in PostgreSQL in order to query and analyze StockX sales data for Yeezy and Nike x Off-White sneakers. SQL queries were written to accomplish a variety of tasks including create custom functions, identify top performing products, and calculate sneakers with the best resale value. 
# Dataset 
